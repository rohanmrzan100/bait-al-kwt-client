...
const Footer = () => {
  return (
    <div className="text-slate-700  bg-white text-sm mt-15">
      <Container>
      ...
      <div className="w-full bg-[#F5F5F3] group">
        <div className="max-w-container mx-auto border-t-[1px] p-10 ">
          <p className="text-titleFont font-normal text-center flex md:items-center justify-center text-lightText duration-200 text-sm">
            ...
            <a
              href="https://www.actnepal.com.np/"
              target="_blank"
              rel="noreferrer"
            >
