...
export default function BannerBottom() {
  return (
    <div className=" shadow-lg 2xl:container 2xl:mx-auto  py-9 bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100">
      <div className=" rounded-lg grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-8 md:gap-12 gap-14 lg:px-20 lg:py-12 py-10 md:px-12 px-4">
        {/* Delivery Grid Card */}
        ...
        <div className="flex flex-col justify-center items-center text-center">
          ...
          <p className="text-base font-normal text-gray-700 mt-4 lg:w-full md:w-9/12 w-full">
            Transactions are secured with end-to-end encryption
          </p>
        </div>
      </div>
    </div>
